...
public class XRStepsPanelWithSignals : MonoBehaviour
{
    ...
    private void Reset()
    {
        ...
        {
            Title = "Шаг 2: Измерение МАЭД гамма-излучения внутри дома",
            Bullets = new[]
            {
                "Измерь МАЭД гамма-излучения в центре каждого помещения не менее 3-х раз.",
                "Измеряй на высоте 1 м от уровня пола.",
                "Результаты измерений впиши в протокол.",
                "Рассчитай среднее измеренное значение МАЭД гамма-излучения внутри каждого помещения и сравни его с минимальным значением МАЭД на открытой местности (норма: не должно превышать более чем на 0,2 мкЗв/ч)."
            }
        };

        steps[2] = new StepData
        {
            Title = "Шаг 3: Сплошная гамма-съемка внутри дома",
            Bullets = new[]
            {
                "Води гамма-детектором вдоль стен и пола на расстоянии не более 30 см.",
                "Запиши показания поискового прибора в протокол.",
                "Максимальное измеренное значение МАЭД гамма-излучения сравни с минимальным измеренным значением МАЭД гамма-излучения на открытой местности (норма: не должно превышать более чем на 0,3 мкЗв/ч)."
            }
        };
